...
def print_with_sumatra(pdf_path, printer_name, scale_opts):
    ...
    if printer_name == "Microsoft Print to PDF":
        ...
        out_dir = os.path.join(os.path.dirname(pdf_path), 'printed_test_pdfs')
        os.makedirs(out_dir, exist_ok=True)
        # build timestamped filename
        timestamp = time.strftime("%Y%m%d-%H%M%S")
        base = os.path.splitext(os.path.basename(pdf_path))[0]
        dest = os.path.join(out_dir, f"{base}_{timestamp}.pdf")
        rand_val = random.randrange(1,1000)
        final = os.path.join(out_dir, f"{dest}_{rand_val}.pdf")
        # copy the file
        try:
...
def process_zpl_file(file_path):
    ...
    if printer_name and printer_name in installed:
        ...
        # scale_opts3 = 'noscale'
        # scale_opts4 = 'center'
        # scale_opts5 = 'fit,paper=4x6.75 Label'
        # scale_opts6 = 'paper=4x6.75 Label'
        # scale_opts7 = 'fit,paper=4x7.25 Label'
        # scale_opts8 = 'paper=4x7.25 Label'
        
        print_with_sumatra(pdf_path, printer_name, scale_opts)
        # print('Scale Opts Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts1)
        # print('Scale Opts 1 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts2)
        # print('Scale Opts 2 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts3)
        # print('Scale Opts 3 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts4)
        # print('Scale Opts 4 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts5)
        # print('Scale Opts 5 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts6)
        # print('Scale Opts 6 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts7)
        # print('Scale Opts 7 Printed')
        # print_with_sumatra(pdf_path, printer_name, scale_opts8)
        # print('Scale Opts 8 Printed')
    else:
